...
class __TwigTemplate_612bdcd79323d2832880646187a0900a778184ee65b9c226c38f1ee3eb1e4a2f extends \Twig\Template
{
    private $source;
    private $macros = [];
...
($context["icon"] ?? null) && ($context["icon_position"] ?? null)) &&  !($context["icon_only"] ?? null))) ? (("icon-" . $this->sandbox->ensureToStringAllowed(($context["icon_position"] ?? null), 30, $this->source))) : (""))];
    ...
    ";
      ...
      ";
        ...
        echo "
  ";
        $___internal_f311305ba9e81a175226c11032cbc9f5e3105d532223781c0f2bf9b243f400db_ = ('' === $tmp = ob_get_clean()) ? '' : new Markup($tmp, $this->env->getCharset());
        // line 25
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar(twig_spaceless($___internal_f311305ba9e81a175226c11032cbc9f5e3105d532223781c0f2bf9b243f400db_));
    }
